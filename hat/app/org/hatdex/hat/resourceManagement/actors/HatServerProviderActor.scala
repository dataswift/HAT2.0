...
class HatServerProviderActor @Inject() (hatServerActorFactory: HatServerActor.Factory) extends Actor with ActorLogging with InjectedActorSupport {
  ...
  private implicit val hatServerTimeout: Timeout = 10.seconds
