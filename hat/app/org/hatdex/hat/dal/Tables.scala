...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = Array(
    Applications.schema,
    ApplicationStatus.schema,
    BundleContextless.schema,
    BundleContextlessDataSourceDataset.schema,
    DataBundles.schema,
    DataCombinators.schema,
    DataDebit.schema,
    DataDebitBundle.schema,
    DataDebitContract.schema,
    DataDebitPermissions.schema,
    DataField.schema,
    DataJson.schema,
    DataJsonGroupRecords.schema,
    DataJsonGroups.schema,
    DataRecord.schema,
    DataStatsLog.schema,
    DataTable.schema,
    DataTableSize.schema,
    DataTabletotablecrossref.schema,
    DataTableTree.schema,
    DataValue.schema,
    HatFile.schema,
    HatFileAccess.schema,
    SheFunction.schema,
    SheFunctionStatus.schema,
    SystemEventlog.schema,
    UserAccessLog.schema,
    UserMailTokens.schema,
    UserRole.schema,
    UserRoleAvailable.schema,
    UserUser.schema
  ).reduceLeft(_ ++ _)
  ...
  class Applications(
    ...
    def * =
      (
        ...
        loginAvailable,
        namespace
      ) <> (ApplicationsRow.tupled, ApplicationsRow.unapply)
    ...
    val dateCreated: Rep[org.joda.time.LocalDateTime] =
      column[org.joda.time.LocalDateTime]("date_created")

    /** Database column date_setup SqlType(timestamp), Default(None) */
    val dateSetup: Rep[Option[org.joda.time.LocalDateTime]] =
      column[Option[org.joda.time.LocalDateTime]]("date_setup", O.Default(None))
  ...
  class ApplicationStatus(
    ...
    def * =
      (
        ...
        version,
        enabled
      ) <> (ApplicationStatusRow.tupled, ApplicationStatusRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(id), Rep.Some(version), Rep.Some(enabled)).shaped.<>(
        { r =>
          import r._;
  ...
  class BundleContextless(
    ...
    def * =
      (
        ...
        dateCreated,
        lastUpdated
      ) <> (BundleContextlessRow.tupled, BundleContextlessRow.unapply)
    ...
    val lastUpdated: Rep[org.joda.time.LocalDateTime] =
      column[org.joda.time.LocalDateTime]("last_updated")
  }
  ...
  class BundleContextlessDataSourceDataset(
    ...
    def * =
      (
        ...
        fieldStructure,
        fieldIds
      ) <> (BundleContextlessDataSourceDatasetRow.tupled, BundleContextlessDataSourceDatasetRow.unapply)
    ...
    def ? =
      (
        ...
        Rep.Some(bundleId),
        Rep.Some(sourceName),
        Rep.Some(datasetName),
        Rep.Some(datasetTableId),
        Rep.Some(description),
  ...
  class DataBundles(
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(bundleId), Rep.Some(bundle)).shaped.<>(
        { r =>
    ...
    val bundle: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("bundle")
  }
  ...
  class DataCombinators(
    ...
    def * =
      (
        combinatorId,
        combinator
      ) <> (DataCombinatorsRow.tupled, DataCombinatorsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(combinatorId), Rep.Some(combinator)).shaped.<>(
        { r =>
    ...
    val combinatorId: Rep[String] =
      column[String]("combinator_id", O.PrimaryKey)

    /** Database column combinator SqlType(jsonb) */
    val combinator: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("combinator")
  }
  ...
  class DataDebit(
    ...
    def * =
      (
        ...
        requestDescription
      ) <> (DataDebitRow.tupled, DataDebitRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (
        Rep.Some(dataDebitKey),
        Rep.Some(dateCreated),
        Rep.Some(requestClientName),
        Rep.Some(requestClientUrl),
        ...
        { r =>
          ...
          _1.map(_ =>
            DataDebitRow.tupled(
              (_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7)
            )
          )
        },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
    ...
    val dataDebitKey: Rep[String] =
      column[String]("data_debit_key", O.PrimaryKey)
    ...
    val requestClientLogoUrl: Rep[String] =
      column[String]("request_client_logo_url")

    /** Database column request_application_id SqlType(varchar), Default(None) */
    val requestApplicationId: Rep[Option[String]] =
      column[Option[String]]("request_application_id", O.Default(None))

    /** Database column request_description SqlType(varchar), Default(None) */
    val requestDescription: Rep[Option[String]] =
      column[Option[String]]("request_description", O.Default(None))
  }
  ...
  class DataDebitBundle(
    ...
    def * =
      (
        ...
        enabled,
        conditions
      ) <> (DataDebitBundleRow.tupled, DataDebitBundleRow.unapply)
    ...
    val startDate: Rep[org.joda.time.LocalDateTime] =
      column[org.joda.time.LocalDateTime]("start_date")

    /** Database column end_date SqlType(timestamp) */
    val endDate: Rep[org.joda.time.LocalDateTime] =
      column[org.joda.time.LocalDateTime]("end_date")
    ...
    val conditions: Rep[Option[String]] =
  ...
  implicit def GetResultDataDebitContractRow(
    ...
    GR { prs =>
      ...
      DataDebitContractRow.tupled(
        (<<[String], <<[org.joda.time.LocalDateTime], <<[java.util.UUID])
      )
    }
  ...
  class DataDebitContract(
    ...
    def * =
      (
        ...
        dateCreated,
        clientId
      ) <> (DataDebitContractRow.tupled, DataDebitContractRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(dataDebitKey), Rep.Some(dateCreated), Rep.Some(clientId)).shaped
        .<>(
          { r =>
            import r._;
  ...
  class DataDebitPermissions(
    ...
    def * =
      (
        ...
        conditions,
        accepted
      ) <> (DataDebitPermissionsRow.tupled, DataDebitPermissionsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (
        Rep.Some(permissionsId),
        Rep.Some(dataDebitKey),
        Rep.Some(dateCreated),
        Rep.Some(purpose),
        Rep.Some(start),
        Rep.Some(period),
        Rep.Some(cancelAtPeriodEnd),
        canceledAt,
        Rep.Some(termsUrl),
        Rep.Some(bundleId),
        conditions,
    ...
    val permissionsId: Rep[Int] =
      column[Int]("permissions_id", O.AutoInc, O.PrimaryKey)
    ...
    val start: Rep[org.joda.time.LocalDateTime] =
      column[org.joda.time.LocalDateTime]("start")
    ...
    val cancelAtPeriodEnd: Rep[Boolean] =
      column[Boolean]("cancel_at_period_end")

    /** Database column canceled_at SqlType(timestamp), Default(None) */
    val canceledAt: Rep[Option[org.joda.time.LocalDateTime]] =
      column[Option[org.joda.time.LocalDateTime]](
        "canceled_at",
        O.Default(None)
      )
  ...
  class DataField(
    ...
    def * =
      (
        ...
        tableIdFk,
        deleted
      ) <> (DataFieldRow.tupled, DataFieldRow.unapply)
    ...
    def ? =
      (
        ...
        { r =>
          ...
          _1.map(_ =>
            DataFieldRow.tupled(
              (_1.get, _2.get, _3.get, _4.get, _5.get, _6.get)
            )
          )
        },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
  ...
  class DataJson(
    ...
    def * =
      (
        ...
        sourceTimestamp,
        sourceUniqueId
      ) <> (DataJsonRow.tupled, DataJsonRow.unapply)
    ...
    def ? =
      (
        ...
        { r =>
          ...
          _1.map(_ =>
            DataJsonRow.tupled(
              (_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7, _8)
            )
          )
        },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
    ...
    val recordId: Rep[java.util.UUID] =
      column[java.util.UUID]("record_id", O.PrimaryKey)
    ...
    val date: Rep[org.joda.time.LocalDateTime] =
      column[org.joda.time.LocalDateTime]("date")

    /** Database column data SqlType(jsonb) */
    val data: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("data")
    ...
    val sourceTimestamp: Rep[Option[org.joda.time.DateTime]] =
      column[Option[org.joda.time.DateTime]](
        "source_timestamp",
        O.Default(None)
      )

    /** Database column source_unique_id SqlType(varchar), Default(None) */
    val sourceUniqueId: Rep[Option[String]] =
  ...
  class DataJsonGroupRecords(
    ...
    def * =
      (
        groupId,
        recordId
      ) <> (DataJsonGroupRecordsRow.tupled, DataJsonGroupRecordsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(groupId), Rep.Some(recordId)).shaped.<>(
        { r =>
          import r._;
  ...
  class DataJsonGroups(
    ...
    def * =
      (
        ...
        owner,
        date
      ) <> (DataJsonGroupsRow.tupled, DataJsonGroupsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(groupId), Rep.Some(owner), Rep.Some(date)).shaped.<>(
        { r =>
          import r._;
    ...
    val groupId: Rep[java.util.UUID] =
      column[java.util.UUID]("group_id", O.PrimaryKey)
  ...
  class DataRecord(
    ...
    def * =
      (
        ...
        name,
        deleted
      ) <> (DataRecordRow.tupled, DataRecordRow.unapply)
  ...
  class DataStatsLog(
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(statsId), Rep.Some(stats)).shaped.<>(
        { r =>
    ...
    val stats: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("stats")
  }
  ...
  class DataTable(
    ...
    def * =
      (
        ...
        sourceName,
        deleted
      ) <> (DataTableRow.tupled, DataTableRow.unapply)
  ...
  class DataTableSize(
    ...
    def * =
      (
        relation,
        totalSize
      ) <> (DataTableSizeRow.tupled, DataTableSizeRow.unapply)

    /** Database column relation SqlType(text), Default(None) */
    val relation: Rep[Option[String]] =
      column[Option[String]]("relation", O.Default(None))

    /** Database column total_size SqlType(int8), Default(None) */
    val totalSize: Rep[Option[Long]] =
      column[Option[Long]]("total_size", O.Default(None))
  }
  ...
  class DataTabletotablecrossref(
    ...
    def * =
      (
        ...
        table2,
        deleted
      ) <> (DataTabletotablecrossrefRow.tupled, DataTabletotablecrossrefRow.unapply)
  ...
  class DataTableTree(
    ...
    def * =
      (
        ...
        path,
        rootTable
      ) <> (DataTableTreeRow.tupled, DataTableTreeRow.unapply)
    ...
    val dateCreated: Rep[Option[org.joda.time.LocalDateTime]] =
      column[Option[org.joda.time.LocalDateTime]](
        "date_created",
        O.Default(None)
      )
    ...
    val lastUpdated: Rep[Option[org.joda.time.LocalDateTime]] =
      column[Option[org.joda.time.LocalDateTime]](
        "last_updated",
        O.Default(None)
      )
    ...
    val name: Rep[Option[String]] =
      column[Option[String]]("name", O.Default(None))

    /** Database column source_name SqlType(varchar), Default(None) */
    val sourceName: Rep[Option[String]] =
      column[Option[String]]("source_name", O.Default(None))

    /** Database column deleted SqlType(bool), Default(None) */
    val deleted: Rep[Option[Boolean]] =
      column[Option[Boolean]]("deleted", O.Default(None))

    /** Database column table1 SqlType(int4), Default(None) */
    val table1: Rep[Option[Int]] =
      column[Option[Int]]("table1", O.Default(None))

    /** Database column path SqlType(_int4), Default(None) */
    val path: Rep[Option[List[Int]]] =
      column[Option[List[Int]]]("path", O.Default(None))

    /** Database column root_table SqlType(int4), Default(None) */
    val rootTable: Rep[Option[Int]] =
      column[Option[Int]]("root_table", O.Default(None))
  }
  ...
  class DataValue(
    ...
    def * =
      (
        ...
        recordId,
        deleted
      ) <> (DataValueRow.tupled, DataValueRow.unapply)
  ...
  class HatFile(
    ...
    def * =
      (
        ...
        status,
        contentPublic
      ) <> (HatFileRow.tupled, HatFileRow.unapply)
    ...
    val tags: Rep[Option[List[String]]] =
      column[Option[List[String]]]("tags", O.Default(None))

    /** Database column title SqlType(varchar), Default(None) */
    val title: Rep[Option[String]] =
      column[Option[String]]("title", O.Default(None))

    /** Database column description SqlType(varchar), Default(None) */
    val description: Rep[Option[String]] =
      column[Option[String]]("description", O.Default(None))

    /** Database column source_url SqlType(varchar), Default(None) */
    val sourceUrl: Rep[Option[String]] =
      column[Option[String]]("source_url", O.Default(None))

    /** Database column status SqlType(jsonb) */
    val status: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("status")

    /** Database column content_public SqlType(bool), Default(false) */
    val contentPublic: Rep[Boolean] =
      column[Boolean]("content_public", O.Default(false))
  }
  ...
  class HatFileAccess(
    ...
    def * =
      (
        ...
        userId,
        content
      ) <> (HatFileAccessRow.tupled, HatFileAccessRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(fileId), Rep.Some(userId), Rep.Some(content)).shaped.<>(
        { r =>
          import r._;
  ...
  /**
    ...
    *  @param bundleId Database column bundle_id SqlType(varchar)
    *  @param headline Database column headline SqlType(varchar)
    ...
    *  @param version Database column version SqlType(varchar)
    *  @param termsUrl Database column terms_url SqlType(varchar)
    *  @param developerId Database column developer_id SqlType(varchar)
    *  @param developerName Database column developer_name SqlType(varchar)
    *  @param developerUrl Database column developer_url SqlType(varchar)
  ...
  class SheFunction(
    ...
    def * =
      ...
      ) <> (SheFunctionRow.tupled, SheFunctionRow.unapply)
    ...
    def ? =
      (
        ...
        Rep.Some(version),
        Rep.Some(termsUrl),
        Rep.Some(developerId),
        Rep.Some(developerName),
        Rep.Some(developerUrl),
        developerCountry,
    ...
    val description: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("description")

    /** Database column trigger SqlType(jsonb) */
    val trigger: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("trigger")

    /** Database column bundle_id SqlType(varchar) */
    val bundleId: Rep[String] = column[String]("bundle_id")

    /** Database column headline SqlType(varchar) */
    val headline: Rep[String] = column[String]("headline")

    /** Database column data_preview SqlType(jsonb), Default(None) */
    val dataPreview: Rep[Option[play.api.libs.json.JsValue]] =
      column[Option[play.api.libs.json.JsValue]](
        "data_preview",
        O.Default(None)
      )

    /** Database column data_preview_endpoint SqlType(varchar), Default(None) */
    val dataPreviewEndpoint: Rep[Option[String]] =
      column[Option[String]]("data_preview_endpoint", O.Default(None))

    /** Database column graphics SqlType(jsonb) */
    val graphics: Rep[play.api.libs.json.JsValue] =
      column[play.api.libs.json.JsValue]("graphics")
    ...
    /** Database column developer_id SqlType(varchar) */
    val developerId: Rep[String] = column[String]("developer_id")

    /** Database column developer_name SqlType(varchar) */
    val developerName: Rep[String] = column[String]("developer_name")

    /** Database column developer_url SqlType(varchar) */
    val developerUrl: Rep[String] = column[String]("developer_url")

    /** Database column developer_country SqlType(varchar), Default(None) */
    val developerCountry: Rep[Option[String]] =
      column[Option[String]]("developer_country", O.Default(None))

    /** Database column version_release_date SqlType(timestamptz) */
    val versionReleaseDate: Rep[org.joda.time.DateTime] =
      column[org.joda.time.DateTime]("version_release_date")

    /** Database column developer_support_email SqlType(varchar) */
    val developerSupportEmail: Rep[String] =
  ...
  class SheFunctionStatus(
    ...
    def * =
      (
        ...
        lastExecution,
        executionStarted
      ) <> (SheFunctionStatusRow.tupled, SheFunctionStatusRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(id), Rep.Some(enabled), lastExecution, executionStarted).shaped
        .<>(
          { r =>
            import r._;
    ...
    val lastExecution: Rep[Option[org.joda.time.DateTime]] =
      column[Option[org.joda.time.DateTime]]("last_execution", O.Default(None))

    /** Database column execution_started SqlType(timestamptz), Default(None) */
    val executionStarted: Rep[Option[org.joda.time.DateTime]] =
      column[Option[org.joda.time.DateTime]](
        "execution_started",
        O.Default(None)
      )
  ...
  class SystemEventlog(
    ...
    def * =
      (
        ...
        command,
        result
      ) <> (SystemEventlogRow.tupled, SystemEventlogRow.unapply)
    ...
    val eventType: Rep[String] =
      column[String]("event_type", O.Length(45, varying = true))

    /** Database column date SqlType(date) */
    val date: Rep[org.joda.time.LocalDate] =
      column[org.joda.time.LocalDate]("date")

    /** Database column time SqlType(time) */
    val time: Rep[org.joda.time.LocalTime] =
      column[org.joda.time.LocalTime]("time")

    /** Database column creator SqlType(varchar), Length(100,true) */
    val creator: Rep[String] =
      column[String]("creator", O.Length(100, varying = true))

    /** Database column command SqlType(varchar), Length(100,true) */
    val command: Rep[String] =
      column[String]("command", O.Length(100, varying = true))

    /** Database column result SqlType(varchar), Length(45,true) */
    val result: Rep[String] =
      column[String]("result", O.Length(45, varying = true))
  }
  ...
  class UserAccessLog(
    ...
    def * =
      (
        ...
        applicationName,
        applicationResource
      ) <> (UserAccessLogRow.tupled, UserAccessLogRow.unapply)
    ...
    val applicationName: Rep[Option[String]] =
      column[Option[String]]("application_name", O.Default(None))

    /** Database column application_resource SqlType(varchar), Default(None) */
    val applicationResource: Rep[Option[String]] =
  ...
  implicit def GetResultUserMailTokensRow(
    ...
    GR { prs =>
      ...
      UserMailTokensRow.tupled(
        (<<[String], <<[String], <<[org.joda.time.LocalDateTime], <<[Boolean])
      )
    }
  ...
  class UserMailTokens(
    ...
    def * =
      (
        ...
        expirationTime,
        isSignup
      ) <> (UserMailTokensRow.tupled, UserMailTokensRow.unapply)
    ...
    val expirationTime: Rep[org.joda.time.LocalDateTime] =
      column[org.joda.time.LocalDateTime]("expiration_time")
  ...
  class UserRole(
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(userId), Rep.Some(role), extra).shaped.<>(
        { r =>
  ...
  class UserUser(
    ...
    def * =
      (
        ...
        name,
        enabled
      ) <> (UserUserRow.tupled, UserUserRow.unapply)
    ...
    def ? =
      (
        ...
        { r =>
          ...
          _1.map(_ =>
            UserUserRow.tupled(
              (_1.get, _2.get, _3.get, _4.get, _5, _6.get, _7.get)
            )
          )
        },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
    ...
    val pass: Rep[Option[String]] =
      column[Option[String]]("pass", O.Default(None))
