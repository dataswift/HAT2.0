INSERT INTO system_type (date_created, last_updated, name, description) VALUES (now(), now(), 'Brand',
                                                                                'The brand(s) associated with a product or service, or the brand(s) maintained by an organization or business person.');
INSERT INTO system_type (date_created, last_updated, name, description)
VALUES (now(), now(), 'ContactPoint', 'A contact point for a person or organization. Supersedes contactPoints');
INSERT INTO system_type (date_created, last_updated, name, description)
...
INSERT INTO system_type (date_created, last_updated, name, description)
VALUES (now(), now(), 'Distance', 'The height of the item');
INSERT INTO system_type (date_created, last_updated, name, description)
...
INSERT INTO system_type (date_created, last_updated, name, description) VALUES (now(), now(), 'PriceSpecification',
...
INSERT INTO system_property
VALUES (3, now(), now(), 'height', 'Body height of a person',
        (SELECT id
         FROM system_type
         WHERE name = 'QuantitativeValue'),
        (SELECT id
