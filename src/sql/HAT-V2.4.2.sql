...
CREATE TABLE public.entity (
                ...
                (CASE WHEN location_id IS NOT NULL AND kind = 'location' THEN 0 ELSE 1 END +
                CASE WHEN thing_id IS NOT NULL AND kind = 'thing' THEN 0 ELSE 1 END +
                CASE WHEN event_id IS NOT NULL AND kind = 'event' THEN 0 ELSE 1 END +
                CASE WHEN organisation_id IS NOT NULL AND kind = 'organisation' THEN 0 ELSE 1 END +
                CASE WHEN person_id IS NOT NULL AND kind = 'person' THEN 0 ELSE 1 END = 1)   
);
